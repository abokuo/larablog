                ...
                <h2>標籤</h2>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">使用標籤：{{ $filtered_tag }} 的文章</li>
                        </ol>
                    </nav>
            </div>
        </div>
                ...
                <article class="entry">
                    ...
                    <div class="entry-meta">
                        <ul>
                            ...
                            <li class="d-flex align-items-center"><i class="bi bi-folder"></i><a href="/category/{{ $post->category->slug }}">{{ $post->category->name }}</a></li>
                            <li class="d-flex align-items-center"><i class="bi bi-chat-dots"></i>
                                <a href="/blog/{{ $post->id }}#comments">{{ $post->comments->count() }} 回應</a></li>
                        </ul>
                    </div>
